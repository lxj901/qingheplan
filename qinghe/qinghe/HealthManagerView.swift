...
struct HealthManagerView: View {
    ...
    @State private var pendingDiagnosisMode: TongueDiagnosisView.Mode? = nil
            ...
            .overlay {
                if showDisclaimer {
                    HealthDisclaimerView(
                        onAgree: {
                            if let mode = pendingDiagnosisMode {
                                if mode == .tongue {
                                    goTongue = true
                                } else {
                                    goFace = true
                                }
                                pendingDiagnosisMode = nil
                            }
