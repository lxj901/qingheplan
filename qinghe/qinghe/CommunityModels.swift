...
struct Author: Codable, Identifiable {
    ...
    var isFollowing: Bool? // 添加关注状态字段

    // 默认初始化器
    init(id: Int, nickname: String, avatar: String?, isVerified: Bool, level: Int?, followersCount: Int?, isFollowing: Bool? = nil) {
        self.id = id
    ...
    private enum CodingKeys: String, CodingKey {
        case id, nickname, avatar, isVerified, level, followersCount, isFollowing
    }
...
struct CommunityUserProfile: Codable, Identifiable {
    ...
    // 默认初始化器
    init(id: Int, nickname: String, avatar: String?, isVerified: Bool, level: Int?, followersCount: Int?, followingCount: Int?, postsCount: Int?, bio: String?, isFollowing: Bool?) {
        self.id = id
        self.nickname = nickname
        self.avatar = avatar
        self.isVerified = isVerified
    ...
    private enum CodingKeys: String, CodingKey {
        case id, nickname, avatar, isVerified, level, followersCount, followingCount, postsCount, bio, isFollowing
    }
}
