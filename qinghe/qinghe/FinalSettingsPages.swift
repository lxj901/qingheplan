...
struct DataSourcesView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // Web 内容渲染：数据来源说明
            InlineWebView(url: URL(string: "https://www.yingwudaojiafuwuduan.cn/data-sources.html")!)
                .ignoresSafeArea(edges: .bottom)
        }
        .onAppear {
            print("🧭 DataSourcesView onAppear - navigationPath.count = \(navigationPath.count)")
        }
    }
...
struct ServiceTermsView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            // Web 内容渲染：服务条款
            InlineWebView(url: URL(string: "https://www.yingwudaojiafuwuduan.cn/service-terms.html")!)
                .ignoresSafeArea(edges: .bottom)
        }
        .onAppear {
...
struct UserAgreementView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            InlineWebView(url: URL(string: "https://www.yingwudaojiafuwuduan.cn/user-agreement.html")!)
                .ignoresSafeArea(edges: .bottom)
        }
        .onAppear {
...
struct MembershipServiceAgreementView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            InlineWebView(url: URL(string: "https://www.yingwudaojiafuwuduan.cn/membership.html")!)
                .ignoresSafeArea(edges: .bottom)
        }
        .onAppear {
...
struct PrivacyPolicyView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            InlineWebView(url: URL(string: "https://www.yingwudaojiafuwuduan.cn/privacy.html")!)
                .ignoresSafeArea(edges: .bottom)
        }
        .onAppear {
