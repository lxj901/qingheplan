...
private struct DisclaimerCard: View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                disclaimerItem(
                    ...
                    title: "重要提示",
                    content: "本检测结果仅供参考，不构成任何医疗诊断、治疗建议或医疗意见。"
                )
                ...
                disclaimerItem(
                    ...
                    iconColor: Color.red,
                    title: "非医疗服务",
                    content: "本功能不是医疗设备，检测结果可能存在误差。如有健康问题，请及时就医并遵循专业医生的诊断和治疗方案。"
                )
                ...
                disclaimerItem(
                    ...
                    title: "用户责任",
                    content: "您不应依赖本功能进行自我诊断或治疗。任何基于本功能做出的健康决策应咨询专业医生，相关后果由您自行承担。"
                )
    ...
    private func disclaimerItem(icon: String, iconColor: Color, title: String, content: String) -> some View {
