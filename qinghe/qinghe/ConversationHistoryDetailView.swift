                            ...
                            VStack(spacing: 0) {
                                ForEach(viewModel.messages) { message in
                                    HistoryMessageBubble(
                                        ...
                                        supplementaryMaterials: message.supplementaryMaterials,
            ...
            VStack(alignment: isUser ? .trailing : .leading, spacing: 4) {
                ...
                if isUser {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        MarkdownTextView(text: content, onLinkTap: onLinkTap)
                ...
                if let messagesData = data.messages, !messagesData.isEmpty {
                    ...
                    messages = messagesData.enumerated().map { (index, msg) in
                        ...
                        return HistoryMessage(
                            ...
                            supplementaryMaterials: msg.supplementaryMaterials
                        )
                    }
