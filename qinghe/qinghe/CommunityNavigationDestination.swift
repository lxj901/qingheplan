...
enum CommunityNavigationDestination: Hashable {
    ...
    case shortVideoFeed(initialPostId: String, videoPosts: [Post])
    case userProfile(String)
    case tagDetail(String)
    case bookCategory  // 书籍分类页面
    case aiQuestionBank  // AI 题库
    case meritStatistics  // 功过格
    case noteCenter  // 笔记中心
    case reviewPlan  // 复习计划
    case sleepManagement  // 睡眠管理
}

// MARK: - 启用系统原生滑动返回手势修饰符
...
// MARK: - UIViewControllerRepresentable 辅助类
private struct SwipeBackGestureHelper: UIViewControllerRepresentable {
